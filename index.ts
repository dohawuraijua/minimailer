...
export async function SendMail(to=null,subject=null, body=null, attachmentUrl=''){
    ...
    if (!to || !subject || body) {
        ...
        let pass_from = process.env.EMAIL_PASSWORD ?? null
         ...
         if (!user_from || !pass_from) {
            return createResponse(400,'Missing required env attribute: EMAIL_FROM and EMAIL_PASSWORD',{});
        }
